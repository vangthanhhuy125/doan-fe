        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-6 overflow-y-auto max-h-[85vh]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="space-y-2">
                ...
                <select 
                  ...
                  className="w-full p-3 bg-white rounded-xl border border-slate-200 outline-none text-sm font-bold text-black focus:border-amber-500"
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-gray-100">
            <div className="space-y-2">
              ...
              <input value={formData.linkTaiLieu} onChange={(e) => setFormData({...formData, linkTaiLieu: e.target.value})} className="w-full p-3 bg-blue-50/50 rounded-xl border border-blue-100 outline-none text-xs focus:bg-white text-black" />
            </div>
            <div className="space-y-2">
              ...
              <input value={formData.linkKeHoach} onChange={(e) => setFormData({...formData, linkKeHoach: e.target.value})} className="w-full p-3 bg-emerald-50/50 rounded-xl border border-emerald-100 outline-none text-xs focus:bg-white text-black" />
            </div>
            <div className="space-y-2">
              ...
              <input value={formData.linkDTKP} onChange={(e) => setFormData({...formData, linkDTKP: e.target.value})} className="w-full p-3 bg-amber-50/50 rounded-xl border border-amber-100 outline-none text-xs focus:bg-white text-black" />
            </div>
            <div className="space-y-2">
              ...
              <input value={formData.linkDRL} onChange={(e) => setFormData({...formData, linkDRL: e.target.value})} className="w-full p-3 bg-purple-50/50 rounded-xl border border-purple-100 outline-none text-xs focus:bg-white text-black" />
            </div>
          </div>

          <div className="pt-6 flex justify-end gap-3">
            <button type="button" onClick={onClose} className="px-6 py-3 rounded-2xl font-bold text-gray-400 hover:bg-gray-100 transition-all uppercase text-xs tracking-widest text-black">Hủy bỏ</button>
            <button type="submit" className="px-10 py-3 bg-amber-500 text-white rounded-2xl font-bold shadow-lg shadow-amber-100 hover:bg-amber-600 transition-all uppercase text-xs tracking-widest">Cập nhật</button>
          </div>
        </form>
      </div>
    </div>
