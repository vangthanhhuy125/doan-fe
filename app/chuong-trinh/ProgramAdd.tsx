  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-md p-4 animate-in zoom-in duration-200">
      <div className="bg-white w-full max-w-3xl rounded-3xl shadow-2xl overflow-hidden border border-white/20">
        ...
        <form className="p-8 space-y-6 overflow-y-auto max-h-[85vh]">
          {/* Tên chương trình & Stakeholder */}
          <div className="space-y-4">
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase text-gray-400 ml-1">Tên chương trình</label>
              <input className="w-full p-4 bg-gray-50 rounded-2xl border border-transparent focus:bg-white focus:border-[#1d92ff] transition-all outline-none text-sm text-black" placeholder="Nhập tên chương trình..." />
            </div>
            
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase text-gray-400 ml-1">Stakeholder (Người phụ trách/Trưởng Ban Tổ chức)</label>
              <input className="w-full p-4 bg-gray-50 rounded-2xl border border-transparent focus:bg-white focus:border-[#1d92ff] transition-all outline-none text-sm text-black" placeholder="VD: Đoàn trường, Khoa CNPM..." />
            </div>
          </div>

          {/* Phân loại thời gian chi tiết */}
          <div className="p-6 bg-slate-50 rounded-2xl space-y-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="space-y-2">
                ...
                <select className="w-full p-3 bg-white rounded-xl border border-slate-200 outline-none text-sm font-bold text-black focus:border-[#1d92ff]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4 border-t border-gray-100">
            <div className="space-y-2">
              ...
              <input className="w-full p-3 bg-blue-50/50 rounded-xl border border-blue-100 outline-none text-xs focus:bg-white text-black" placeholder="https://drive.google.com/..." />
            </div>
            <div className="space-y-2">
              ...
              <input className="w-full p-3 bg-emerald-50/50 rounded-xl border border-emerald-100 outline-none text-xs focus:bg-white text-black" placeholder="https://drive.google.com/..." />
            </div>
            <div className="space-y-2">
              ...
              <input className="w-full p-3 bg-amber-50/50 rounded-xl border border-amber-100 outline-none text-xs focus:bg-white text-black" placeholder="https://drive.google.com/..." />
            </div>
            <div className="space-y-2">
              ...
              <input className="w-full p-3 bg-purple-50/50 rounded-xl border border-purple-100 outline-none text-xs focus:bg-white text-black" placeholder="https://drive.google.com/..." />
            </div>
          </div>

          <div className="pt-6 flex justify-end gap-3">
            <button type="button" onClick={onClose} className="px-6 py-3 rounded-2xl font-bold text-gray-400 hover:bg-gray-100 transition-all text-xs tracking-widest">Hủy bỏ</button>
            <button type="submit" className="px-10 py-3 bg-[#1d92ff] text-white rounded-2xl font-bold shadow-lg shadow-blue-100 hover:bg-[#0054a5] transition-all text-xs tracking-widest">Lưu dữ liệu</button>
          </div>
        </form>
      </div>
    </div>
